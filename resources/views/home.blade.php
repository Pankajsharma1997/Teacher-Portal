     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="#" class="navbar-brand">Learning Mantra</a>
               </div>
                         ...
                         <div class="entry-form">
                              <form action="{{route('loginall')}}" method="post">
                                  ...
                                  <div class="alert alert-danger">{{Session::get('fail')}} </div>
                                   ...
                                   <input type="password" name="password" class="form-control" placeholder="Your password" required="" value="{{old('password')}}">
                    ...
                    <div class="col-md-3 col-sm-6">
                         <div class="team-thumb">
                              <div class="team-image">
                                   <img src="{{ asset('storage/' . $member->image) }}" class="img-responsive" alt="{{ $member->name }}">
                              ...
                              <div class="team-info">
                                   <h3>{{ $member->name}} </h3>
                                   <span> Skills:{{$member->skills}}</span>
                              </div>
                                   ...
                                   <div class="item">
                                        <div class="courses-thumb">
                                             ...
                                             <div class="courses-detail">
                                                  <h3><a href="{{route('coursedetail', $course->id)}}">{{$course->title }}</a></h3>
     ...
     <section id="contact">
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <form id="contact-form" role="form" action="{{route('contactUs')}}" method="post">
                              @csrf
                              <div class="section-title">
